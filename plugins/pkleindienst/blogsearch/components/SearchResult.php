...
//ATENÇÃO :  Se deseja incluir a pesquisa no conteudo e nao somente por titulo
// consulte a linha 274 desse codigo
...
class SearchResult extends ComponentBase
{
    ...
    protected function listPosts()
    {
        ...
        $posts = BlogPost::where(function ($q) {
            ...
            /* Ao descomentar vai começar a pesquisar no conteudo tambem
